...
class Visitor;
/*
 * The scene node provides control over the object. This component provides functionality
 * such as resizing, moving, rotating and scaling the object inside the scene.
 */
...
public:
    ...
    */
    ...
    DirectX::XMMATRIX GetDefaultTransform() const;
