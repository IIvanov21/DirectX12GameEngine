...
class Resource;
/*
 * This is a class simply creates a list that tracks each resource to
 * prevent memory fragmentation and ensures each resource gets transition correctly.
 * It ensures that happens by pushing the correct resource barrier in front of the
 * resource in the resource state tracker.
 */
...
public:
     ...
     *
     *  barrier The resource barrier to push to the resource state tracker.
     */
     ...
     * stateAfter The state to transition the resource to.
     ...
     *
     *  resource The resource to add a UAV barrier for. Can be NULL which
     ...
     *
     *  beforeResource The resource currently occupying the space in the heap.
     *  afterResource The resource that will be occupying the space in the heap.
     *
