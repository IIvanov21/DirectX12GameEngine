...
namespace Math
{
    ...
    */
    ...
    inline float Distance2D(DirectX::XMVECTOR v1, DirectX::XMVECTOR v2)
    {
        float distX = DirectX::XMVectorGetX( v1 ) - DirectX::XMVectorGetX( v2 );
        float distY = DirectX::XMVectorGetY( v1 ) - DirectX::XMVectorGetY( v2 );

        return sqrt( distX * distX + distY * distY );
    }

    inline float Distance3D( DirectX::XMVECTOR v1, DirectX::XMVECTOR v2 )
    {
        float distX = DirectX::XMVectorGetX( v1 ) - DirectX::XMVectorGetX( v2 );
        float distY = DirectX::XMVectorGetY( v1 ) - DirectX::XMVectorGetY( v2 );
        float distZ = DirectX::XMVectorGetZ( v1 ) - DirectX::XMVectorGetZ( v2 );
