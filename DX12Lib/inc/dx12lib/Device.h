...
#include <memory>
/*
 * The device handles the creation of all instance and
 * provides control to the developer to manage everything for
 * the application such as Render Targets, Descriptors, Command Lists, Resource Control in general etc..
 */
