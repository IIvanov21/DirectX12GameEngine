...
/*
 * The command list is a list of drawing or state-changing
 * calls that execute on the Graphics Processing Unit.
 */
...
public:
     ...
     *  stateAfter The state to transition the resource to. The before state is resolved by the resource state tracker.
     * subresource The subresource to transition. By default, this is D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES
     * which indicates that all subresources are transitioned to the same state.
     * flushBarriers Force flush any barriers. Resource barriers need to be flushed before a command (draw,
     ...
     *
     *  [resource} The resource to add a UAV barrier for (can be null).
     *  flushBarriers Force flush any barriers. Resource barriers need to be
     ...
     *
     *  [beforeResource] The resource that currently occupies the heap (can be null).
     *  [afterResource] The resource that will occupy the space in the heap (can be null).
     */
     ...
     * Load a scene file.
     *
     *  fileName The path to the scene file definition.
     *  [loadingProgress] An optional callback function that can be used to report loading progress.
     */
     ...
     *
     *  sceneString The scene file definition as a string.
     *  format The format of the scene file. (for example "NFF")
     */
     ...
     * Create a cube.
     *
     *  size The size of one side of the cube.
     *  reverseWinding Whether to reverse the winding order of the triangles (useful for skyboxes).
     */
     ...
     *  tessellation Determines how smooth the sphere is.
     *  reverseWinding Whether to reverse the winding order of the triangles (useful for sydomes).
     */
     ...
     * Create a Cylinder
     *
     *  radius The radius of the primary axis of the cylinder.
     *  hight The height of the cylinder.
     *  tessellation How smooth the cylinder will be.
     *  reverseWinding Whether to reverse the winding order of the triangles.
     */
     ...
     *  tessellation How smooth to make the cone.
     *  reverseWinding Whether to reverse the winding order of the triangles.
     */
     ...
     *  thickness The The thickness of the torus.
     *  tessellation The smoothness of the torus.
     *  reverseWinding Reverse the winding order of the vertices.
     */
     ...
     *
     *  indexBuffer The index buffer to bind to the rendering pipeline.
     */
...
protected:
     ...
     *
     *  pendingCommandList The command list that is used to execute pending
...
private:
    ...
    using VertexCollection = std::vector<DX12_Library::VertexPositionNormalTangentBitangentTexture>;
