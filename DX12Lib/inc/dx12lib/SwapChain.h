...
class Texture;
/*
 * The swap chain simply controls the back-buffer properties i.e. what gets rendered on the screen and
 * how it gets rendered on the screen.
 */
class SwapChain
{
public:
