...
{
/*
 * The materials class contains functions and properties that allow
 * the developer to customise and create custom texture without
 * the need of loading textures.
 */
class Texture;
