...
class Visitor;
/*
 * The scene component handles how a object gets rendered
 * and positioned inside the scene. This component also handles the importing
 * of textures/materials and the mesh associated with the scene object.
 */
class Scene
{
public:
