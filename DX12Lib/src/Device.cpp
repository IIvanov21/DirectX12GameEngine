...
std::shared_ptr<DX12_Library::IndexBuffer>
    DX12_Library::Device::CreateIndexBuffer( Microsoft::WRL::ComPtr<ID3D12Resource> resource, size_t numIndices,
                                        DXGI_FORMAT indexFormat )
{
...
std::shared_ptr<DX12_Library::VertexBuffer>
    DX12_Library::Device::CreateVertexBuffer( Microsoft::WRL::ComPtr<ID3D12Resource> resource, size_t numVertices,
                                         size_t vertexStride )
{
...
std::shared_ptr<DX12_Library::RootSignature>
    DX12_Library::Device::CreateRootSignature( const D3D12_ROOT_SIGNATURE_DESC1& rootSignatureDesc )
{
