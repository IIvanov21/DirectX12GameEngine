...
public:
     ...
     * Camera Picking
     */
    DirectX::XMVECTOR PixelFromWorldPt( DirectX::XMVECTOR PixelPoint, DirectX::XMVECTOR worldPoint, uint32_t ViewportWidth,
                           uint32_t ViewportHeight,bool& isBehind );
    DirectX::XMVECTOR WorldPtFromPixel( DirectX::XMVECTOR entityVector, uint32_t viewportWidth,
